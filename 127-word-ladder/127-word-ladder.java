...
// 			 getRelatedWords(s,q,wordList,visitedset);
// 		        }
// 			 ++level;
// 		 }
...
// 	 public void getRelatedWords(String word,Queue<String> q,List<String> set, Set<String> visitedset){
...
// 				 if(set.contains(str) && !visitedset.contains(str)){
// 					 q.add(str);
// 					 visitedset.add(str);
// 				 }
